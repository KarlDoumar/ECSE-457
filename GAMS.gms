Sets
            ...
            Li(s)                   Dynamic set of lithium-ion batteries /3/
...
*Use_case1(s,t,m)..           B(s,t,'1') =g= (-lambda(t,'1'))*y(s,t,m) + alpha(t)*p(s,t,'1');

*abs_pos(s,t,m)..             y(s,t,'1') =g= (g_a(t) + p(s,t,'1') - g_t(t));

*abs_neg(s,t,m)..             y(s,t,'1') =g= -1*(g_a(t) + p(s,t,'1') - g_t(t));

*abs_const(s,t,m)..           y(s,t,'1') =g= 0;



*Price arbitrage (m = 3)

Use_case1(s,t,m)..          B(s,t,'1') =e= alpha(t)*p(s,t,'1');
